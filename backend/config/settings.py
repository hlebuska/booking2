...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # по умолчанию 5 минут, увеличим до 60
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30),    # по умолчанию 1 день, увеличим до 30
